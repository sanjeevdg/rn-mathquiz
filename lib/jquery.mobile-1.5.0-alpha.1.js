...
(function (root, doc, factory) {
    ...
    (function (factory) {
        ...
        var compensateToolbars = function (page, desiredHeight) {
            ...
            noPadders = function () {
                var theElement = $(this), widgetOptions = $.mobile.toolbar && theElement.data("mobile-toolbar") ?
        ...
        $.mobile.widget.theme = {
            ...
            _setOption: function (key, value) {
                ...
                $.each(this._themeElements(), function (i, toTheme) {
                    ...
                    if (themeOption === key) {
                        that._removeClass(toTheme.element, null, toTheme.prefix + that.options[toTheme.option || "theme"])
    ...
    (function (factory) {
        ...
        $.widget("mobile.loader", {
            ...
            show: function (theme, msgText, textonly) {
                ...
                this._removeClass.apply(this, ["ui-loader-verbose ui-loader-default ui-loader-textonly"]
                    .concat(currentTheme))
                    ._addClass("ui-loader-" +
                    (textVisible || msgText || theme.text ? "verbose" : "default") +
                    (loadSettings.textonly || textonly ? " ui-loader-textonly" : ""), "ui-body-" + theme);
    ...
    (function (factory) {
        ...
        var fakeBody = $("<body>").prependTo("html"), fbCSS = fakeBody[0].style, vendors = ["Webkit", "Moz", "O"], webos = "palmGetResource" in window, //only used to rule out scrollTop
        ...
        $.event.special.swipe = {
            ...
            start: function (event) {
                var data = event.originalEvent.touches ?
                    event.originalEvent.touches[0] : event, location = $.event.special.swipe.getLocation(data);
                return {
    ...
    (function (factory) {
        ...
        var throttle = 250, lastCall = 0, heldCall, curr, diff, handler = function () {
        ...
        $.widget("mobile.pagecontainer", {
            ...
            _loadSuccess: function (absUrl, triggerData, settings, deferred) {
                ...
                return $.proxy(function (html, textStatus, xhr) {
                    ...
                    pageElemRegex = new RegExp("(<[^>]+\\bdata-" + this._getNs() + "role=[\"']?page[\"']?[^>]*>)"), dataUrlRegex = new RegExp("\\bdata-" + this._getNs() + "url=[\"']?([^\"'>]*)[\"']?");
    ...
    (function (factory) {
        ...
        $.extend($.mobile.Transition.prototype, {
            ...
            transition: function (toScroll) {
                ...
                var none, reverseClass = this.reverse ? " reverse" : "", screenHeight = $(window).height(), maxTransitionOverride = $.mobile.maxTransitionWidth !== false &&
    ...
    (function (factory) {
        ...
        $.mobile.degradeInputsWithin = function (target) {
            ...
            target.find("input").not($.mobile.keepNative).each(function () {
                var html, findstr, repstr, element = $(this), type = this.getAttribute("type"), optType = $.mobile.degradeInputs[type] || "text";
            ...
            _setCloseButton: function (location, text) {
                ...
                if (this.dialog.button) {
                    if ("none" === location) {
                        ...
                        this._removeClass(this.dialog.button, null, "ui-toolbar-header-button-left ui-toolbar-header-button-right")
    ...
    (function (factory) {
        ...
        $.widget("mobile.collapsible", {
                    ...
                    options[key] =
                        (options[key] != null) ? options[key] :
                            (accordionWidget) ? accordionWidget.options[key] :
                                accordion.length ? $.mobile.getAttribute(accordion[0], key.replace(rInitialLetter, "-$1").toLowerCase()) :
                                    null;
                    if (null == options[key]) {
            ...
            _enhance: function (elem, ui) {
                var opts = this._renderedOptions, contentThemeClass = this._themeClassFromOption("ui-body-", opts.contentTheme);
            ...
            _updateIcon: function () {
                var ui = this._ui, opts = this._getOptions(this.options), iconclass = opts.collapsed ?
                    (opts.collapsedIcon ? " ui-icon-" + opts.collapsedIcon : "") :
                    (opts.expandedIcon ? " ui-icon-" + opts.expandedIcon : ""), method = opts.iconpos === ("bottom" || "right") ? "append" : "prepend";
                if (ui.icon) {
                    ui.icon.remove();
                }
                if (ui.space) {
            ...
            _applyOptions: function (options) {
                var isCollapsed, newTheme, oldTheme, hasCorners, elem = this.element, currentOpts = this._renderedOptions, ui = this._ui, anchor = ui.anchor, status = ui.status, opts = this._getOptions(options);
        ...
        $.fn.grid = function (options) {
            return this.each(function () {
                var $this = $(this), o = $.extend({
                    grid: null
                }, options), $kids = $this.children(), gridCols = { solo: 1, a: 2, b: 3, c: 4, d: 5 }, grid = o.grid, iterator, letter;
                if (!grid) {
                    if ($kids.length <= 5) {
    ...
    (function (factory) {
        ...
        function isOutOfSight(element, windowCoordinates) {
            ...
            return !(pointInRectangle(offset.left, offset.top, windowCoordinates) ||
        ...
        $.widget("mobile.popup", {
            ...
            _setTolerance: function (value) {
                var tol = { t: 30, r: 15, b: 30, l: 15 }, ar;
                if (value !== undefined) {
    ...
    (function (factory) {
        ...
        var getAttribute = $.mobile.getAttribute, countBubbleClassRegex = /\bui-listview-item-count-bubble\b/;
        function filterBubbleSpan() {
            var child, parentNode, anchorHash = { "a": true, "A": true };
        ...
        return $.widget("mobile.listview", $.extend({
            ...
            _refresh: function (create, items) {
                var buttonClass, pos, numli, item, itemClass, itemExtraClass, itemTheme, itemIcon, icon, a, isDivider, value, last, splittheme, li, dictionaryKey, span, allItems, newSpan, currentOptions = this.options, list = this.element, ol = !!$.nodeName(list[0], "ol"), start = list.attr("start"), itemClassDict = {};
                    ...
                    if (create || this._processListItem(item)) {
                        ...
                        if (a.length && ((this._processListItemAnchor(a) && !isDivider) ||
                            ...
                            if (a.length > 1) {
                                ...
                                addItemToDictionary(itemClassDict, span[0], "ui-listview-item-split-icon", "ui-icon ui-icon-" +
                                    (getAttribute(last[0], "icon") || itemIcon ||
                                        currentOptions.splitIcon));
                                addItemToDictionary(itemClassDict, last[0], "ui-listview-item-split-button", "ui-button ui-button-icon-only" +
                ...
                for (dictionaryKey in itemClassDict) {
                    ...
                    this._addClass.apply(this, [$(itemClassDict[dictionaryKey])]
    ...
    (function (factory) {
        ...
        return $.widget("mobile.listview", $.mobile.listview, {
            ...
            _replaceDividers: function () {
                var existingDivider, existingDividerText, lastDividerText, items = this._getChildrenByTagName(this.element[0], "li", "LI");
    ...
    (function (factory) {
        ...
        var rdivider = /(^|\s)ui-listview-item-divider($|\s)/, rhidden = /(^|\s)ui-screen-hidden($|\s)/;
        return $.widget("mobile.listview", $.mobile.listview, {
            options: {
                hideDividers: false
            },
    ...
    (function (factory) {
        ...
        $.widget("mobile.textinput", {
            ...
            _create: function () {
                var options = this.options, isSearch = this.element.is("[type='search'], :jqmData(type='search')"), isTextarea = this.element[0].nodeName.toLowerCase() === "textarea";
    ...
    (function (factory) {
        ...
        $.widget("mobile.slider", $.extend({
            ...
            _create: function () {
                ...
                var control = this.element, cType = control[0].nodeName.toLowerCase(), isRangeslider = control.parent().is(":jqmData(role='rangeslider')"), controlID = control.attr("id"), $label = $("[for='" + controlID + "']"), labelID = $label.attr("id") || controlID + "-label", min = parseFloat(control.attr("min")), max = parseFloat(control.attr("max")), step = window.parseFloat(control.attr("step") || 1), domHandle = document.createElement("a"), handle = $(domHandle), domSlider = document.createElement("div"), slider = $(domSlider), wrapper;
            ...
            refresh: function (val, isfromControl, preventInputUpdate) {
                ...
                var self = this, left, width, data, tol, pxStep, percent, control, min, max, step, newval, valModStep, alignValue, percentPerStep, handlePercent, aPercent, bPercent, valueChanged;
    ...
    (function (factory) {
        ...
        return $.widget("mobile.flipswitch", $.extend({
            ...
            _enhance: function () {
                var flipswitch = $("<div>"), options = this.options, element = this.element, tabindex = this._originalTabIndex || 0, theme = options.theme ? options.theme : "inherit", 
                // The "on" button is an anchor so it's focusable
                on = $("<span tabindex='" + tabindex + "'></span>"), off = $("<span></span>"), onText = (this.type === "input") ?
                    options.onText : element.find("option").eq(1).text(), offText = (this.type === "input") ?
            ...
            _findLabels: function () {
                var input = this.element[0], labelsList = input.labels;
            ...
            _setOptions: function (options) {
                if (options.theme !== undefined) {
                    var currentTheme = this.options.theme ? this.options.theme : "inherit", newTheme = options.theme ? options.theme : "inherit";
    ...
    (function (factory) {
        ...
        $.widget("mobile.rangeslider", $.extend({
            ...
            _create: function () {
                var _inputFirst = this.element.find("input").first(), _inputLast = this.element.find("input").last(), _label = this.element.find("label").first(), _sliderWidgetFirst = $.data(_inputFirst.get(0), "mobile-slider") ||
                    $.data(_inputFirst.slider().get(0), "mobile-slider"), _sliderWidgetLast = $.data(_inputLast.get(0), "mobile-slider") ||
                    $.data(_inputLast.slider().get(0), "mobile-slider"), _sliderFirst = _sliderWidgetFirst.slider, _sliderLast = _sliderWidgetLast.slider, firstHandle = _sliderWidgetFirst.handle, _sliders = $("<div>");
            ...
            _updateHighlight: function () {
                var min = parseInt($.data(this._inputFirst.get(0), "mobile-slider")
                    .handle.get(0).style.left, 10), max = parseInt($.data(this._inputLast.get(0), "mobile-slider")
                    .handle.get(0).style.left, 10), width = (max - min);
    ...
    (function (factory) {
        ...
        return $.widget("mobile.textinput", $.mobile.textinput, {
            ...
            _toggleClasses: function (add) {
                ...
                this._toggleClass(this._clearButton, "ui-textinput-clear-button", "ui-button ui-button-icon-only ui-button-right", add);
    ...
    (function (factory) {
        ...
        var selectmenu = $.widget("mobile.selectmenu", [{
                ...
                _create: function () {
                    var options = this.options, iconpos = options.icon ?
                    ...
                    if (this.options.icon) {
                        this.icon = $("<span>");
                        this._addClass(this.icon, "ui-selectmenu-button-icon", "ui-icon-" + options.icon + " ui-icon ui-widget-icon-float" +
    ...
    (function (factory) {
        ...
        $.widget("mobile.toolbar", {
            ...
            _create: function () {
                var leftbutton, rightbutton, role = this.options.type, page = this.element.closest(".ui-page"), toolbarAriaRole = this.options.ariaRole === null ?
                    role === "header" ? "banner" :
            ...
            _initWidgets: function () {
                ...
                this.childWidgets = this.childWidgets.map(function () {
                    ...
                    if (selectmenuWidget) {
                        ...
                        // horizontal.
                        selectmenuWidget.option("classes.ui-selectmenu", selectmenuWidget.option("classes.ui-selectmenu")
                            .replace(uiButtonInlineRegex, "")
                            .trim());
                        selectmenuWidget.option("classes.ui-selectmenu-button", selectmenuWidget.option("classes.ui-selectmenu-button")
    ...
    (function (factory) {
        ...
        return $.widget("mobile.toolbar", $.mobile.toolbar, {
            ...
            _setOptions: function (o) {
                ...
                if (this.options.position === "fixed") {
                    var pageActive = $(".ui-page-active"), currentPage = !!this.page ?
                        this.page :
                        pageActive.length ?
                            pageActive :
                            $(".ui-page").eq(0);
            ...
            _useTransition: function (notransition) {
                var $win = this.window, $el = this.element, scroll = $win.scrollTop(), elHeight = $el.height(), pHeight = (!!this.page) ? $el.closest(".ui-page").height() :
                    $(".ui-page-active").height(), viewportHeight = $(window).height();
                return !notransition &&
                    (this.options.transition && this.options.transition !== "none" &&
                        ((this.role === "header" && !this.options.fullscreen && scroll > elHeight) ||
                            (this.role === "footer" && !this.options.fullscreen &&
                                scroll + viewportHeight < pHeight - elHeight)) || this.options.fullscreen);
            },
        ...
        if ($.mobileBackcompat !== false) {
            return $.widget("mobile.toolbar", $.mobile.toolbar, {
                ...
                _viewportOffset: function () {
                    var $el = this.element, header = $el.hasClass("ui-toolbar-header"), offset = Math.abs($el.offset().top - this.window.scrollTop());
                    if (!header) {
                ...
                _bindListThumbWorkaround: function () {
                    var pageActive = $(".ui-page-active"), currentPage = !!this.page ? this.page : pageActive.length ?
    ...
    (function (factory) {
        ...
        return $.widget("mobile.popup", $.mobile.popup, {
            ...
            _tryAnArrow: function (p, dir, desired, s, best) {
                ...
                tip[p.snd] = Math.max(result[p.prop] + s.guideOffset[p.prop] + s.arHalf[p.dimKey], Math.min(result[p.prop] + s.guideOffset[p.prop] + s.guideDims[p.dimKey] -
            ...
            _placementCoords: function (desired) {
                ...
                this._removeClass(ar.ct, "ui-popup-arrow-l ui-popup-arrow-t ui-popup-arrow-r ui-popup-arrow-b")
    ...
    (function (factory) {
        ...
        return $.widget("mobile.panel", {
            ...
            _createModal: function () {
                var that = this, target = that._parentPage ? that._parentPage.parent() : that.element.parent();
                that._modal = $("<div>");
            ...
            _getWrapper: function () {
                var thePage, wrapper = this._page().find(".ui-panel-wrapper");
                if (wrapper.length === 0) {
                    thePage = this._page();
                    wrapper = $("<div>");
                    this._addClass(wrapper, "ui-panel-wrapper");
                    wrapper = this._safelyWrap(thePage, wrapper, this._page().children(".ui-toolbar-header:not(.ui-toolbar-header-fixed), " +
            ...
            _getFixedToolbars: function () {
                var extFixedToolbars = $("body")
                    .children(".ui-toolbar-header-fixed, .ui-toolbar-footer-fixed"), intFixedToolbars = this._page()
                    .find(".ui-toolbar-header-fixed, .ui-toolbar-footer-fixed"), fixedToolbars = extFixedToolbars.add(intFixedToolbars);
            ...
            _positionPanel: function (scrollToTop) {
                var heightWithMargins, heightWithoutMargins, that = this, panelInnerHeight = that._panelInner.outerHeight(), expand = panelInnerHeight > this.window.height();
            ...
            _handleClick: function (e) {
                var link, panelId = this.element.attr("id"), that = this;
            ...
            open: function (immediate) {
                if (!this._open) {
                    var that = this, o = that.options, complete = function () {
                        ...
                        if (o.theme && o.display !== "overlay") {
                            that._addClass(that._page().parent(), "ui-panel-page-container-themed ui-panel-page-container-" + o.theme);
                        }
            ...
            close: function (immediate) {
                if (this._open) {
                    ...
                    currentPage = that._page(), o = this.options, complete = function () {
                        if (o.theme && o.display !== "overlay") {
                            that._removeClass(currentPage.parent(), "ui-panel-page-container-themed ui-panel-page-container-" + o.theme);
                        }
            ...
            _destroy: function () {
                var otherPanels, o = this.options, multiplePanels = ($("body > :mobile-panel").length +
                ...
                if (o.display !== "overlay") {
                    ...
                    if (this._open) {
                        ...
                        if (o.theme) {
                            this._removeClass(this._page().parent(), "ui-panel-page-container-themed ui-panel-page-container-" + o.theme);
                        }
                    }
                }
                if (!multiplePanels) {
    ...
    (function (factory) {
        ...
        return $.widget("mobile.table", {
            ...
            _refreshHeaderCell: function (cellIndex, element, columnCount) {
                var columnIndex, span = parseInt(element.getAttribute("colspan"), 10), selector = ":nth-child(" + (columnCount + 1) + ")";
                if (span) {
                ...
                $(element).jqmData("cells", this.allRowsExceptFirst
                    .not(element)
                    .children(selector));
                return columnCount;
            },
        ...
        return $.widget("mobile.table", $.mobile.table, {
            ...
            _updateHeaderPriorities: function (state) {
                this.headers.each($.proxy(function (index, element) {
                    var header = $(element), priority = $.mobile.getAttribute(element, "priority");
                    if (priority) {
                ...
                if ($.type(cell) === "number") {
                    ...
                    if (this.headers.index(cell[0]) >= 0) {
                        ...
                        this.headers.each($.proxy(function (index, singleHeader) {
                            var possibleHeader = $(singleHeader), cells = possibleHeader.jqmData("cells");
            ...
            _destroy: function () {
                if (this.options.mode === "columntoggle") {
                    if (!this.options.enhanced) {
                        this.headers.each($.proxy(function (index, element) {
                            var header, priority = $.mobile.getAttribute(element, "priority");
                            if (priority) {
                                header = $(element);
                                header
        ...
        return $.widget("mobile.table", $.mobile.table, {
            ...
            _removeColumnUi: function (detachOnly) {
                ...
                inputs.each(function () {
                    var input = $(this), header = input.jqmData("header");
                ...
                if (this.options.mode === "columntoggle") {
                    ...
                    if (haveUi) {
                        ...
                        if (options.columnButtonTheme != null && this._ui.button) {
                            this._removeClass(this._ui.button, null, this._themeClassFromOption("ui-button-", this.options.columnButtonTheme));
                            this._addClass(this._ui.button, null, this._themeClassFromOption("ui-button-", options.columnButtonTheme));
                        }
            ...
            _columnsButton: function () {
                var id = this._id(), options = this.options, button = $("<a href='#" + id + "-popup' " +
                    "id='" + id + "-button' " +
            ...
            _recordLockedColumns: function () {
                var headers = this.headers, lockedColumns = [];
                // Find the index of the column header associated with each old checkbox among the
                // post-refresh headers and, if the header is still there, make sure the corresponding
                // column will be hidden if the pre-refresh checkbox indicates that the column is
                // hidden by recording its index in the array of hidden columns.
                this._ui.menu.find("input").each(function () {
                    var input = $(this), header = input.jqmData("header"), index = -1;
                    if (header) {
                    ...
                    if (index > -1) {
                        ...
                        lockedColumns = lockedColumns.concat(header.hasClass("ui-table-cell-visible") ?
    ...
    (function (factory) {
        ...
        return $.widget("mobile.table", $.mobile.table, {
            ...
            _updateCellsFromHeader: function (index, headerCell) {
                var iteration, cells, colstart, labelClasses, header = $(headerCell), contents = header.clone().contents();
    ...
    (function (factory) {
        ...
        var defaultFilterCallback = function (index, searchValue) {
            var element, text = $.mobile.getAttribute(this, "filtertext");
            if (!text) {
                element = $(this);
                text = element.text();
                if (!text) {
        ...
        return $.widget("mobile.filterable", {
            ...
            _getFilterableItems: function () {
                var elem = this.element, children = this.options.children, items = !children ? { length: 0 } :
