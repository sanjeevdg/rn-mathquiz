    ...
    const getCardsHtml = () => {
        ...
        for (let index = 0; index < myquestions.length; index++) {
            ...
            if (index === 0)
                ...
                act = "";
            if (myquestions[index].qans === 1)
                ansa = "answer";
            else
                ansa = "";
            if (myquestions[index].qans === 2)
                ansb = "answer";
            else
                ansb = "";
            if (myquestions[index].qans === 3)
                ansc = "answer";
            else
                ansc = "";
            if (myquestions[index].qans === 4)
                ansd = "answer";
            else
                ansd = "";
 ...
 $("#nextbtn").click(function(){
  ...
  <head></head><body></body></html>`;
    ...
    */
    ...
    //0acf83
    //#e85e3d  -----orange
    return (_jsx(View, { style: styles.container, children: _jsx(WebView, { originWhitelist: ['*'], source: { html: modifiedGetHtml }, scalesPageToFit: true, 
            ...
            javaScriptEnabled: true, allowFileAccess: true, allowUniversalAccessFromFileURLs: true, domStorageEnabled: true, style: { flexGrow: 1, flex: 1, width: moderateScale(width, 0.05),
